            ...
            <div className="flex justify-center h-screen w-screen items-center">
                <img className="flex" src={Gambar} alt="imglogin" />
                    <div className="w-4/12 border border-gray-300 rounded p-10 bg-blue-200">
                        <h1 className="text-2xl text-center text-white font-semibold p-1">DAFTAR</h1>
                            <div className="h-2 bg-indigo-400 rounded-t-md"></div>
                                <div className="px-3 py-1 "></div>
                                    <h5 className="text-center ">Please enter your Data</h5>
                                        <div className="mb-4">
                                        ...
                                        <div className="mb-4">
                                            <input type="text" className="border border-gray-400 py-2 px-4 w-full" value={email} onChange={onChangeEmail} placeholder="Email" />
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <button className="bg-pink-500 py-2 px-4 rounded text-white">Daftar</button>
